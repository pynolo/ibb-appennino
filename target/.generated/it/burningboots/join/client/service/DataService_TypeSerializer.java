...
public class DataService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["it.burningboots.join.shared.PropertyBean/2226618166"] = [
        @it.burningboots.join.shared.PropertyBean_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.PropertyBean_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/burningboots/join/shared/PropertyBean;),
      ];
    
    result["it.burningboots.join.shared.SystemException/4265430224"] = [
        @it.burningboots.join.shared.SystemException_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.SystemException_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/burningboots/join/shared/SystemException;),
      ];
    
    result["it.burningboots.join.shared.entity.Config/3321973573"] = [
        @it.burningboots.join.shared.entity.Config_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.entity.Config_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/burningboots/join/shared/entity/Config;),
        @it.burningboots.join.shared.entity.Config_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/burningboots/join/shared/entity/Config;)
      ];
    
    result["it.burningboots.join.shared.entity.IpnResponse/2299540477"] = [
        @it.burningboots.join.shared.entity.IpnResponse_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.entity.IpnResponse_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/burningboots/join/shared/entity/IpnResponse;),
        @it.burningboots.join.shared.entity.IpnResponse_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/burningboots/join/shared/entity/IpnResponse;)
      ];
    
    result["it.burningboots.join.shared.entity.Participant/2869526322"] = [
        @it.burningboots.join.shared.entity.Participant_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.entity.Participant_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/burningboots/join/shared/entity/Participant;),
        @it.burningboots.join.shared.entity.Participant_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/burningboots/join/shared/entity/Participant;)
      ];
    
    result["[Lit.burningboots.join.shared.entity.Participant;/1157775170"] = [
        @it.burningboots.join.shared.entity.Participant_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.burningboots.join.shared.entity.Participant_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lit/burningboots/join/shared/entity/Participant;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.PropertyBean::class)] = "it.burningboots.join.shared.PropertyBean/2226618166";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.SystemException::class)] = "it.burningboots.join.shared.SystemException/4265430224";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.entity.Config::class)] = "it.burningboots.join.shared.entity.Config/3321973573";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.entity.IpnResponse::class)] = "it.burningboots.join.shared.entity.IpnResponse/2299540477";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.entity.Participant::class)] = "it.burningboots.join.shared.entity.Participant/2869526322";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@it.burningboots.join.shared.entity.Participant[]::class)] = "[Lit.burningboots.join.shared.entity.Participant;/1157775170";
